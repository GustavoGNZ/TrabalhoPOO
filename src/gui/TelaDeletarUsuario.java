...
public class TelaDeletarUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(TIDUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 170, 260, 30));
    ...
    private void BDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BDeletarActionPerformed
        ...
        String idUserString = TIDUsuario.getText();
        int idUser = 0;
        ...
        try {
            ...
            Logger.getLogger(TelaDeletarUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
